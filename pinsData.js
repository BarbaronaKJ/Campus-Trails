...
export const pins = [
  ...
  { 
    ...
    image: require('./assets/USTP.jpg'), building: "OF", neighbors: [1030, 1034, 1026, 1029]
  },
  { 
    id: "MC", x: 970, y: 500, title: "MC", 
    description: "Movable Classrooms", 
    image: require('./assets/USTP.jpg'), building: "MC", neighbors: [1016.1] 
  },
  { 
    id: 1, 
    x: 1580, 
  ...
  { 
    ...
    image: require('./assets/USTP.jpg'), building: "19", neighbors: [1003.3] 
  },
  { 
    id: 20, 
    x: 995, y: 1000, 
  ...
  { 
    ...
    image: require('./assets/USTP.jpg'), building: "24", neighbors: [1018.2, 1024] 
  },
  { 
    id: 25, 
    x: 670, y: 605, 
  ...
  { 
    ...
    image: require('./assets/USTP.jpg'), building: "27", neighbors: [1016.3] 
  },
  { 
    id: 28, 
    x: 685, y: 730, 
  ...
  { 
    ...
    image: require('./assets/USTP.jpg'), building: "35", neighbors: [1018.1] 
  },
  { 
    id: 36, x: 410, y: 640, 
    title: "36", 
    description: "BLDG 36 | Old Student Center", 
    image: require('./assets/USTP.jpg'), building: "36", neighbors: [1018.2] 
  },
  { 
    id: 41, x: 750, y: 825, 
    title: "41", 
    description: "BLDG 41 | Science Complex", 
    image: require('./assets/USTP.jpg'), building: "41", neighbors: [1003.6] 
  },
  { 
    id: 42, x: 1100, y: 1095, 
    title: "42", 
    description: "BLDG 42 | Engineering Complex I (Right Wing)", 
    image: require('./assets/USTP.jpg'), building: "42", neighbors: [1003.3] 
  },
  { 
    id: 43, x: 980, y: 1108, 
    title: "43", 
    description: "BLDG 43 | Engineering Complex II (Left Wing)", 
    image: require('./assets/USTP.jpg'), building: "43", neighbors: [1001.3] 
  },
  { 
    id: 44, 
    x: 660, y: 1010, 
